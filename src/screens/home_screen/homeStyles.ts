...
export const styles = StyleSheet.create({
  ...
  featuredContent:   { position: 'absolute', bottom: 0, width: '100%', alignItems: 'center', paddingBottom: 68 },
  ...
  animeHeroContent: {
    paddingHorizontal: 18,
    paddingTop: 30,
    paddingBottom: 135, // sits beautifully above absolute thumbnails
    justifyContent: 'flex-end',
    flex: 1,
  },
  animeTag: {
  ...
  animeThumbnailActive: {
    shadowColor: '#fff',
    shadowOffset: { width: 0, height: 4 },
    shadowOpacity: 0.25,
    shadowRadius: 6,
  },
  animeThumbnailActiveOverlay: {
    ...StyleSheet.absoluteFillObject,
    borderWidth: 2,
    borderColor: '#fff',
    borderRadius: 10,

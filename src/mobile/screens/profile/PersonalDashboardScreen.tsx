  ...
  const menuItems = [
    {
      ...
      subtitle: t('dashboard.saved_subtitle') || 'Saved movies & shows',
    ...
    },
    {
      ...
      subtitle: t('dashboard.history_subtitle') || 'Recent viewing activity',
      icon: 'time' as const,
    ...
    },
    {
      ...
      subtitle: t('dashboard.comments_subtitle') || 'Your thoughts & replies',
    ...
    },
    {
      ...
      subtitle: t('dashboard.friends_subtitle') || 'Your community hub',
        ...
        >
          <View style={styles.introSection}>
            <Text style={styles.welcomeText}>
              {t('dashboard.welcome') || 'Personal Space'}
            </Text>
            <Text style={styles.subWelcomeText}>
              {t('dashboard.intro') || 'Manage your watch lists, interactions, and connections in one custom place.'}
            </Text>
          </View>
